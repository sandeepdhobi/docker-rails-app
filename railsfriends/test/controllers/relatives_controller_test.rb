...
class RelativesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create relative" do
    assert_difference('Relative.count') do
      post relatives_url, params: { relative: { name: @relative.name, relation: @relative.relation } }
    end
  ...
  test "should update relative" do
    patch relative_url(@relative), params: { relative: { name: @relative.name, relation: @relative.relation } }
